...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--semantic-loss-type", type=str, default="mse")
    p.add_argument("--semantic-loss-weight", type=float, default=0.5)
...
def main() -> None:
    ...
    # Set semantic loss type and weight
    model.setup_semantic_loss(semantic_loss_type=args.semantic_loss_type, semantic_loss_weight=args.semantic_loss_weight)
    ...
    monitor_metric = "val_semantic_loss" # Change this if necessary
