...
model_name = "RobotsMali/soloba-ctc-0.6b-v3"
...
The NeMo toolkit was used for finetuning this model for **39,000 steps** over `RobotsMali/soloba-ctc-0.6b-v2` model with batch size 32. The finetuning codes and configurations can be found at [RobotsMali-AI/bambara-asr](https://github.com/RobotsMali-AI/bambara-asr/).
